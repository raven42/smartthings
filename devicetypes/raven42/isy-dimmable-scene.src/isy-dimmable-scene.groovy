 ...
 *
 *  FIXME: Currently the dimming functionality does not work. From the smartthings end it appears to all function as
 *	expected, however the scene does not update in the ISY hub. It will turn it on, but not set the on-level.
 */
metadata {
	definition (name: "ISY Dimmable Scene", namespace: "raven42", author: "David Hegland") {
		capability "Actuator"
		capability "Switch"
